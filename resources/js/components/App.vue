<template>
  <div>
            ...
            <button v-if="todas === 0" @click="verTodas();" type="button" class="btn btn-outline-primary">
                Ver todas las tareas
            </button>
            <button v-else @click="verTodas();" type="button" class="btn btn-outline-primary">
                Mis tareas
            </button>
      ...
      <div v-if="todas === 0">
        ...
        <hr>
            ...
            <button @click="modificar=false; openModal();" type="button" class="btn btn-primary btn-lg btn-block my-4">
            Nueva Tarea
            </button>
...
<script>
import ConsultarTareasComponent from './ConsultarTareasComponent.vue';
export default {
  components: { ConsultarTareasComponent },
    props: ['user'],
    data(){
        return {
            tarea:{
